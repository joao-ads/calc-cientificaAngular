...
@Component({
  ...
  templateUrl: './cientifica.component.html', //indica onde serão usadas as funçoes os metodos
...
export class CientificaComponent implements OnInit {
  ...
  */
  ...
  inserirPi(): void{
    /// verificar se é display é vazio ou 0
    const PI = (Math.PI).toString();
    /// Se estamos digitando o primeiro número ou o segundo e limpar a variavel
    if(this.operacao == 'null'){
      this.numero1 = ''
    } else {
      this.numero2 = ''
